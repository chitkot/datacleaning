...
This dataset was generated from a larger dataset from the experiements conducted with 30 individuals who performed six activities (Walking, Walking-Upstairs, Walking-Downstairs, Sitting, Standing, and Laying) wearing the smartphone Galaxy S II on the waist. Information about these experiments is available at: 
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones. The original dataset for the project is available at: 
https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 

This subset of the larger dataset was generated using the following steps:
1. The test and training data sets were combined into a larger dataset
...
5. The resulting datase was melted into a long, thin data set: Variables that identified subject and activities were preserved, all measurement variables were melted into a single column
...
* 'run_analysis.R': The script for performing the analysis and describing all the data cleaning workd performed.
