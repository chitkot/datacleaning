...
I created the subset of the dataset by following these steps:  

1. Combined the the test and training sets into a larger dataset
2. Extracted measurements of the mean and standard deviation and created a smaller dataset. I limited this new dataset to measurements of mean and standard deviations, by searching the variable names and extracting variables that had "mean" or "std" as part of the name. 
